        ...
        <div class="container">
            <div class="columns">
                <div class="column is-4">
                    <div class="box">
                        <h6 class="title is-6 has-text-centered">Pilih barang</h6>
                        <form action="{{ route('cart.store') }}" method="post">
                            ...
                            <div class="field">
                                <div class="control has-text-right">
                                    <button type="submit" class="button is-info is-rounded">Tambah</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <div class="column is-8">
                    <div class="box">
                        <h6 class="title is-6 has-text-centered">Pembayaran</h6>
                        <form action="{{ route('transaction.store') }}" method="post">
                            ...
                            <div class="field">
                                <div class="control has-text-right">
                                    <button type="submit" class="button is-info is-rounded">Bayar</button>
                                </div>
                            </div>
                        </form>
                    </div>
                ...
                <tbody>
                    @foreach($itemCarts as $item)
                        <tr>
                            ...
                            <td>
                                <button class="button is-light modal-button is-rounded is-small" data-target="#ubahJumlah{{ $loop->iteration }}">Ubah</button>
                                <form action="{{ route('cart.destroy', $item->cart) }}" method="post">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="button is-danger is-small">Hapus</button>
                                </form>
